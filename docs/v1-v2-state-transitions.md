# AutoNAT State Transitions: v1 vs v2 Across Implementations

How each AutoNAT implementation decides a node is reachable or
unreachable, how it changes that decision, and how the decision
propagates to other protocols.
...
- [v1 vs v2 performance comparison](v1-vs-v2-performance.md)

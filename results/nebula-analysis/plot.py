...
Note: 04_oscillation.csv and 07_joint_state.csv are no longer plotted.
04 was superseded by 06 (same data, finer resolution).
07 was superseded by 08 (same data, finer resolution).
The CSVs are still generated by the queries documented in
docs/nebula-autonat-analysis.md but the chart functions have been removed.
